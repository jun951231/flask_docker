...
class MyPandas(object):
    ...
    def __init__(self):
        ...
        # df['과학'] = 0
        #
        # df.loc['ckSVA'] = [93, 44, 14, 94, 94]
        # df.loc['CAOot'] = [25, 54, 29, 10, 94]
        # df.loc['fZTCh'] = [82, 65, 31, 31, 94]
        # df.loc['mqZJJ'] = [51, 56, 56, 3, 94]
        # df.loc['BKlLt'] = [34, 32, 67, 48, 94]
        # df.loc['KKYUN'] = [85, 24, 16, 8, 94]
        # df.loc['WAjFK'] = [28, 80, 52, 43, 94]
        # df.loc['yBVgG'] = [25, 94, 93, 54, 94]
        # df.loc['lGmwZ'] = [32, 50, 95, 1, 94]
        # df.loc['GQzmY'] = [26, 37, 80, 27, 94]
        # ic(df)
